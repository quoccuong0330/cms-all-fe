...
const customDataController = require('../../controllers/cms/customData.controller.js');
const customUploadFileController = require('../../controllers/cms/customUploadFile.controller.js');
const resetCustomDataController = require('../../controllers/cms/resetCustomData.controller.js')
const initDatabaseController = require('../../controllers/cms/initDatabase.controller.js')
...
const productUpdateController = require('../../controllers/cms/productUpdate.controller.js');
const productDeleteController = require('../../controllers/cms/productDelete.controller.js');
const newProductCreateController = require('../../controllers/cms/newProductCreate.controller.js');
...
//route custom file
router.get('/custom-file', (req, res) => {
...
router.get('/custom-data', (req, res) => {
  customDataController.action(req, res);
});

router.delete('/custom-data/reset',(req,res) => {
  resetCustomDataController.action(req,res);
})

router.post('/custom-data/init',(req,res) => {
  initDatabaseController.action(req,res);
})
